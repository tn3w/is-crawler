...
| [is_crawler_minimal.py](is_crawler_minimal.py)     | 14-token `in` check. ~79% recall, 0.1% FP. Fastest.                      |
| [is_crawler_full.py](is_crawler_full.py)           | Keywords + URL/email + browser-signature negation. ~95% recall, 0.4% FP. |
